...
# data
# >>> [{'system_output': 'Peter and Elizabeth attend party city. Elizabeth rushed hospital.', 'source': 'Peter and Elizabeth took a taxi to attend the night party in the city.              While in the party, Elizabeth collapsed and was rushed to the hospital.', 'reference': 'Elizabeth was hospitalized after attending a party with Peter.'}]
# breakpoint()
# Initialize evaluator for a specific task
evaluator = get_evaluator(task)
